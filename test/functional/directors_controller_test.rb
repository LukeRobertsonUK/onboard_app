...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { date_of_birth: @director.date_of_birth, duedil_director_url: @director.duedil_director_url, duedil_id: @director.duedil_id, forename: @director.forename, surname: @director.surname }
    end
  ...
  test "should update director" do
    put :update, id: @director, director: { date_of_birth: @director.date_of_birth, duedil_director_url: @director.duedil_director_url, duedil_id: @director.duedil_id, forename: @director.forename, surname: @director.surname }
    assert_redirected_to director_path(assigns(:director))
  end
